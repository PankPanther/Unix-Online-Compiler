...
var terminal_mode = 'V';
var isMobile = false;
var SERVER = "https://H9bvBJK2PF2L.com/cg";
var $win = null;
var userid = null;
var username = null;
var preview = false;
...
if( compile ){
    ...
    }else if( langid === "perl" || langid === "ruby" || langid === "rubyterm" || langid  === "matplotlib" || langid === "numpyterm"  || langid === "scipyterm" || langid === "scipy" || langid === "numpy" || langid === "python3"  || langid  === "rscript" || langid === "octave" || langid === "octaveterm" || langid === "rterm" || langid === "nodejsterm" || langid === "unixterm" || langid === "python3term" || langid == "pashterm" ||  langid == "lua" ||  langid == "luaterm" || langid == "forth" || langid === "jython" || langid === "java8" || langid == "kotlin" || langid === "ksh" || langid === "tcl" || langid === "lisp" || langid === "icon" || langid === "intercal" || langid === "sqlite"){
         server = "https://tpcg3.tutorialspoint.com";
    }
    if( langid == "python" || langid == "php" ||  langid == "ruby" || langid == "lolcode" || langid == "malbolge" || langid == "mozart" || langid == "nimrod" || langid == "ocaml" || langid == "pari" || langid == "pike" || langid == "prolog" || langid == "rust" || langid == "scheme" || langid == "simula" || langid == "smalltalk" || langid == "smlnj" || langid == "unlambda" || langid == "verilog" || langid == "wspace" || langid == "phpweb")    {
...
if( isMobile ){
    $("#logo").attr("src", " https://H9bvBJK2PF2L.com/static/images/logo-icon.png");
    $("#logo").css("width", "50px");
        ...
        success: function(data) {
	     var tab = $('#codebox').tabs('getSelected');
             $('#codebox').tabs('update', {
               ...
               tab.panel('refresh', SERVER + "/change_password.php?emailid=" + data.message);
               $("#loading").css({ "visibility": "hidden" });
...
function createProject() {
    ...
    $.ajax({
          ...
          success: function(data) {
             window.location = 'https://H9bvBJK2PF2L.com/codingground.htm';
             $("#loading").css({
                "visibility": "hidden"
             });
          }
